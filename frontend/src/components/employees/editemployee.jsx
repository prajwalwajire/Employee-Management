...
const EditEmployee = () => {
  ...
  useEffect(() => {
    const fetchEmployeeData = async () => {
      try {
        const response = await axios.get(
          `https://employee-management-mefe.onrender.com/employee/employee_s/${id}/${employeeId}`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://employee-management-mefe.onrender.com/employee/update_employee/${employeeId}`,
        employeeData
      );
